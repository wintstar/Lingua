...
$txt['delete_all'] = 'Alle Mitteilungen in deiner PMBOX löschen';
...
$txt['pm_email'] = 'Du hast eine Private Mitteilung von SENDER im Forum ' . $context['forum_name'] . ' erhalten.' . "\n\n" . 'WICHTIG: Das ist nur eine Benachrichtigung - bitte antworte nicht auf diese E-Mail!' . "\n\n" . 'Die Nachricht, die an dich gesendet wurde:' . "\n\n" . 'MESSAGE';
...
$txt['pm_sent'] = 'Deine Nachricht wurde erfolgreich versandt.';

$txt['pm_error_user_not_found'] = 'Kann Mitglied \'%1$s\' nicht finden.';
$txt['pm_error_ignored_by_user'] = 'Mitglied \'%1$s\' hat deine Mitteilungen geblockt.';
...
$txt['pm_too_many_recipients'] = 'Du kannst persönliche Nachrichten nicht an mehr als %1$d Empfänger auf einmal schicken.';
...
$txt['pm_labels_desc'] = 'Hier kannst du Labels zu deinen Privaten Mitteilungen hinzufügen, editieren und löschen.';
...
$txt['pm_is_replied_to'] = 'Du hast diese Mitteilung weitergeleitet oder schon darauf geantwortet.';

// Reporting messages.
$txt['pm_report_to_admin'] = 'Administrator informieren';
$txt['pm_report_title'] = 'Private Mitteilung melden';
$txt['pm_report_desc'] = 'Hier kannst du Private Mitteilungen den Administratoren des Forums melden. Bitte füge eine kurze Beschreibung an, warum du diese Mitteilung melden möchtest. Die Beschreibung wird mit der Originalnachricht versendet.';
...
$txt['pm_visual_verification_desc'] = 'Bitte gib den Code aus dem Bild ein, um die Mitteilung zu versenden.';

$txt['pm_settings'] = 'Einstellungen ändern';
$txt['pm_change_view'] = 'Ansicht wechseln';

$txt['pm_manage_rules'] = 'Regeln verwalten';
$txt['pm_manage_rules_desc'] = 'Hier kannst du deine eingehenden Privaten Mitteilungen automatisch nach bestimmten Kriterien sortieren. Um eine Regel zu bearbeiten, klicke den Namen der Regel an.';
...
$txt['pm_rule_js_disabled'] = '<span class="alert"><b>Hinweis:</b> Du scheinst Javascript deaktiviert zu haben. Wir empfehlen dringend Javascript zu Aktivieren um diese Funktion zu nutzen.</span> ';
...
$txt['pm_rule_too_complex'] = 'Die erstellte Regel ist zu lang, um von SMF gespeichert zu werden. Versuche die Regel in mehrere kurze Regeln aufzuteilen.';
