...
$txt['permission_cannot_edit'] = '<strong>Achtung:</strong> Du kannst dieses Berechtigungsprofil nicht editieren, da es ein vordefiniertes Profil ist, welches standardmäßig in SMF integriert ist. Wenn Du es verändern möchtest musst Du zuerst eine Kopie des Profils erstellen. Du kannst den Vorgang starten, in dem Du <a href="%1$s">hier</a> klicken.';
...
$txt['permissions_profiles_desc'] = 'Berechtigungsprofile können den einzelnen Boards zugeordnet werden, um die Sicherheitseinstellungen einfach zu verwalten. Hier kannst Du die Profile erstellen, editieren und löschen.';
...
$txt['permissions_deny_dangerous'] = 'Du verbietest eine oder mehrere Berechtigungen.\\nDies kann unter Umständen unvorhergesehene Folgen nach sich ziehen, wenn Du nicht kontrolliert hast, ob ein Mitglied \\"fälschlicherweise\\" in der betreffenden Gruppe ist.\\n\\nBist Du sicher, dass Du fortfahren möchtest?';
...
$txt['permissions_option_desc'] = 'Für jede Berechtigung kannst Du \'Erlauben\' (E), \'Nicht erlauben\' (X) oder <span style="color: red;">\'Verbieten\' (V)</span> auswählen.<br /><br />Beachte: Wenn Du eine Berechtigung verbietest, kann kein Mitglied - weder Moderator noch andere - in dieser Gruppe die betreffende Funktion nutzen.<br />Deshalb benutze diese Option mit größter Sorgfalt und nur wenn es <strong>nötig</strong> ist. \'Nicht erlauben\' verbietet nur so lange, bis es an anderer Stelle erlaubt wird.';
...
$txt['permissionhelp_view_stats'] = 'Die Forumstatistiken fassen alle Statistiken wie Mitgliederanzahl, täglich geschriebene Beiträge und mehrere Top 10 Statistiken zusammen. Wenn Du diese Berechtigung aktivierst, wird der Link (\'Weitere Statistiken\') im unteren Teil des Board-Index hinzugefügt.';
$txt['permissionname_view_mlist'] = 'Mitgliederliste und Gruppen anzeigen';
$txt['permissionhelp_view_mlist'] = 'Die Mitgliederliste zeigt alle Mitglieder des Forums an. Sie kann sortiert und durchsucht werden und ist vom Board-Index und innerhalb der Statistiken verlinkt, wenn Du dort auf die Mitgliederanzahl klickst. Sie gilt außerdem für die Gruppen-Seite, welche eine Mini-Mitgliederliste mit Benutzern dieser Gruppe darstellt.';
$txt['permissionname_who_view'] = '\'Wer ist online\' anschauen';
$txt['permissionhelp_who_view'] = '\'Wer ist online\' zeigt alle Mitglieder, die aktuell online sind und was sie gerade machen. Diese Berechtigung funktioniert nur, wenn Du die Funktion in den \'Forumeinstellungen\' aktiviert hast. Du kannst die Aktionen anschauen, wenn Du auf den Link \'Wer ist online\' im Board-Index klickst.';
...
$txt['permissionhelp_karma_edit'] = 'Karma ist eine Funktion, die den Beliebtheitsgrad eines Benutzers anzeigt. Um sie benutzen zu können, musst Du es in den \'Forumeinstellungen\' aktiviert haben. Diese Berechtigung erlaubt es einer Mitgliedergruppe eine Wertung abzugeben und steht Gästen nicht zur Verfügung.';
...
$txt['permissionhelp_admin_forum'] = 'Diese Berechtigung erlaubt dem Benutzer das:<ul class="normallist"><li>Ändern der Einstellungen des Forums, der Datenbank und der Themes</li><li>Verwalten von Paketen</li><li>Benutzen der Wartungsfunktionen</li><li>Anschauen der Fehler- bzw. Moderator-Protokollen</li></ul> Benutze diese Berechtigung mit Vorsicht, da sie sehr mächtig ist.';
...
$txt['permissionname_profile_server_avatar'] = 'Wähle ein Benutzerbild vom Server';
$txt['permissionhelp_profile_server_avatar'] = 'Aktiviere diese Option, um den Benutzern die Möglichkeit zu geben, ein auf diesem Server gespeichertes Benutzerbild auszuwählen.';
...
$txt['permissionhelp_remove'] = 'Diese Berechtigung erlaubt das Löschen ganzer Themen. Bitte beachte, dass mit dieser Funktion keine einzelnen Beiträge gelöscht werden dürfen!';
...
$txt['permission_by_board_desc'] = 'Hier kannst Du einstellen, ob ein Board die globalen Berechtigungen benutzt oder ein eigenes Schema verwendet. Solltest Du lokale Berechtigungen verwenden, kannst Du im betreffenden Board für jede Mitgliedergruppe individuelle Berechtigungen angeben.';
$txt['permission_settings_desc'] = 'Wähle hier, wer die Erlaubnis zum ändern der Berechtigungen hat und wie komplex das Berechtigungssystem sein soll.';
...
$txt['permissions_post_moderation_deny_note'] = 'Solltest Du die erweiterten Berechtigungen aktiviert haben, kannst Du von dieser Seite aus keine Berechtigung "Verbieten (V)". Bitte editiere die betreffende Berechtigung direkt, um sie zu verbieten.';
