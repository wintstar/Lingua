<?php
// Version: 2.1 Beta 2; Admin -- 2.1* German translate Update by www.Scaricare.de

global $settings, $scripturl;

$txt['settings_saved'] = 'Die Einstellungen wurden erfolgreich gespeichert';
$txt['settings_not_saved'] = 'Ihre Änderungen wurden nicht gespeichert, weil: %1$s';

$txt['admin_boards'] = 'Boards und Kategorien';
...
$txt['admin_agreement_not_saved'] = 'Die Änderungen der Vereinbarung wurden nicht gespeichert. Vielleicht waren die Dateisystemberechtigungen auf die Datei nicht korrekt eingestellt.';
$txt['admin_delete_members'] = 'Ausgewählte Mitglieder löschen';
$txt['admin_repair'] = 'Alle Boards und Themen reparieren';
$txt['admin_main_welcome'] = 'Das ist dein &quot;%1$s&quot;. Hier kannst du dieEinstellungen ändern, das Forum warten, Protokolle anschauen, Pakete installieren, die Styles verwalten und viele weitere Optionen verändern. Solltest du Probleme haben, lese bitte den Abschnitt  &quot;Allgemeiner Support &amp; Fehler&quot; im Bereich Support &amp; Würdigung. Sollten diese Informationen nicht helfen, kannst du auch im <a href="http://www.simplemachines.org/community/index.php" target="_blank">Support Forum</a> nach Hilfe fragen.<br>Bitte klicke auch das <span class="generic_icons help" title="%3$s"></span> Symbol an, um eine Beschreibung der Funktion zu erhalten.';
$txt['admin_news_desc'] = 'Hier kannst du News-Meldungen hinzufügen oder löschen. Bitte schreibe eine News-Meldung pro Textfeld. Einige BBC Tags wie [b], [i] und [u] sind erlaubt, ebenso Smileys. Lösche den Text eines Textfeldes um die Meldung zu entfernen.';
...
$txt['zero_to_disable'] = '(Setze 0, um zu deaktivieren.)';
$txt['dont_show_attach_under_post'] = 'Dateianhänge unter dem Beitrag nicht anzeigen, wenn diese bereits eingebettet sind.';
$txt['dont_show_attach_under_post_sub'] = 'Aktiviere diese Option, wenn du nicht möchtest, das Dateianhänge zweimal angezeigt werden. Dateianhänge die im Beitrag eingebettet sind, werden weiterhin zur Dateianhang Begrenzungen angerechnet und können weiterhin wie normale Dateianhänge behandelt werden.';

$txt['admin_backup_fail'] = 'Kopieren von Settings.php fehlgeschlagen - überprüfe bitte, ob die Datei Settings_bak.php existiert und überschreibbar ist.';
...
$txt['attachmentdir_files_current'] = 'Dateianhänge insgesamt im aktuellen Upload-Verzeichnis';
$txt['attachment_space'] = 'Verfügbarer Speicherplatz im Upload-Verzeichnis';
$txt['attachment_files'] = 'Dateien insgesamt verbleiben';
...
$txt['attachmentdir_files_not_set'] = 'Upload-Verzeichnis ist derzeit unbegrenzt eingestellt.';
$txt['attachment_delete_admin'] = '[gelöscht durch einen Administrator]';
...
$txt['smileys_manage'] = 'Smileys und Beitragssymbole';
$txt['theme_admin'] = 'Style und Layout';
...
$txt['security_wrong'] = 'Administrator Anmelde Versuch!' . "\n" . 'Verweis von: %1$s' . "\n" . 'Benutzeragent: %2$s' . "\n" . 'IP-Adresse: %3$s';
...
$txt['warnings_desc'] = 'Dieses System ermöglicht es Administratoren und Moderatoren, um Verwarnungen an Benutzer zu erteilen, und können automatisch Benutzerrechte wie ihre Verwarnung Erhöhungen entfernen. Um alle Vorteile dieses Systems zu nutzen, sollte &quot;Beitragsmoderation&quot; aktiviert werden.';
...
$txt['maintain_info'] = 'Hier kannst du mit diesen Tools die Datenbanktabellen optimieren, Backups erstellen, auf Fehler überprüfen und dein Board bereinigen.';
...
$txt['spider_log_desc'] = 'Prüfe die Einträge die sich auf Suchmaschinen-Bots-Aktivität beziehen.';
$txt['log_settings_desc'] = 'Verwende diese Optionen, um festzulegen, wie die Protokollierung auf deinem Forum funktioniert.';
$txt['modlog_enabled'] = 'Moderatoren Protokoll aktivieren';
$txt['adminlog_enabled'] = 'Administrator Protokoll aktivieren';
$txt['userlog_enabled'] = 'Profil Bearbeitungen Protokoll aktivieren';
...
$txt['attachment_manager_avatars_older'] = 'Entferne Avatare von Mitgliedern, die länger inaktiv sind als';
...
$txt['attachmentUploadDir'] = 'Upload Verzeichnisse';
$txt['attachmentUploadDir_multiple'] = 'Upload Verzeichnisse verwalten';
...
$txt['attachment_img_enc_warning'] = 'Weder GD-Modul noch IMagick oder MagickWand Erweiterungen sind derzeit installiert. Bild Neu Codierung ist nicht möglich.';
$txt['attachment_postsize_warning'] = 'Die aktuelle php.ini Einstellung \'post_max_size\' kann dies nicht unterstützen.';
$txt['attachment_filesize_warning'] = 'Die aktuelle php.ini Einstellung \'upload_max_filesize\' kann dies nicht unterstützen.';
$txt['attachment_image_reencode'] = 'Neukodierung potenziell gefährlicher Bild Anhänge';
$txt['attachment_image_reencode_note'] = '(Erfordert GD Module oder ImageMagick mit IMagick oder MagickWand Erweiterung)';
...
$txt['attachmentThumbnails'] = 'Bilder verkleinern, wenn diese im Beitrag angezeigt werden';
$txt['attachment_thumb_png'] = 'Vorschaubilder als PNG speichern';
$txt['attachment_thumb_memory'] = 'Adaptive Vorschaubilder Speicher';
...
$txt['attachment_security_settings'] = 'Dateianhang Sicherheitseinstellungen';
...
$txt['attach_dir_duplicate_msg'] = 'Dieses Verzeichnis kann nicht hinzugefügt werden, da dies bereits vorhanden ist.';
$txt['attach_dir_exists_msg'] = 'Dieses Verzeichnis kann nicht verschoben werden, da ein Verzeichnis unter diesem Pfad bereits vorhanden ist.';
$txt['attach_dir_base_dupe_msg'] = 'Dieses Verzeichnis kann nicht hinzugefügt werden, dieses Basisverzeichnis bereits erstellt wurde.';
$txt['attach_dir_base_no_create'] = 'Dieses Verzeichnis kann nicht erstellt werden. Bitte überprüfe die Pfadeingabe. Oder erstelle dieses Verzeichnis mit einem FTP-Client oder eine Websieiten-Dateiverwaltung und versuche es erneut.';
$txt['attach_dir_no_rename'] = 'Dieses Verzeichnis kann nicht verschoben oder umbenannt werden. Bitte überprüfe ob der Pfade korrekt ist oder dass dieses Verzeichnis keine Unterverzeichnisse enthält.';
$txt['attach_dir_no_delete'] = 'Dieses Verzeichnis ist nicht leer und kann nicht gelöscht werden. Bitte verwende einen FTP-Client oder eine Websieiten-Dateiverwaltung.';
$txt['attach_dir_no_remove'] = 'Dieses Verzeichnis enthält weiterhin Dateien oder ist ein Basisverzeichnis und kann nicht gelöscht werden.';
$txt['attach_dir_is_current'] = 'Dieses Verzeichnis kann nicht entfernt werden, solange es als das aktuelle Verzeichnis ausgewählt ist.';
$txt['attach_dir_is_current_bd'] = 'Dieses Verzeichnis kann nicht entfernt werden, während dieses als dass aktuelle Basisverzeichnis markiert ist.';
$txt['attach_dir_invalid'] = 'Ungültiges Verzeichnis';
$txt['attach_last_dir'] = 'Letztes aktive Upload-Verzeichnis';
$txt['attach_current_dir'] = 'Aktuelles Upload-Verzeichnis';
$txt['attach_current'] = 'Aktuell';
$txt['attach_path_manage'] = 'Upload-Verzeichnis Pfad verwalten';
$txt['attach_directories'] = 'Upload-Verzeichnis';
$txt['attach_paths'] = 'Upload-Verzeichnis Pfade';
...
$txt['attach_path_current_bad'] = 'Ungültiger Pfad für Upload-Verzeichnis.';
$txt['attachmentDirFileLimit'] = 'Maximale Anzahl Dateien pro Verzeichnis';

$txt['attach_base_paths'] = 'Basisverzeichnis Pfade';
$txt['attach_num_dirs'] = 'Verzeichnisse';
$txt['max_image_width'] = 'Max. Breite im Beitrag angezeigte oder angehängte Bilder anzeigen';
$txt['max_image_height'] = 'Max. Höhe im Beitrag angezeigte oder angehängte Bilder anzeigen';

$txt['automanage_attachments'] = 'Wähle die Methode für das Verwaltung der Upload-Verzeichnisse';
$txt['attachments_normal'] = '(Manuell) SMF-Standardverhalten';
$txt['attachments_auto_years'] = '(Auto) Unterteilen von Jahren';
$txt['attachments_auto_months'] = '(Auto) Unterteilen von Jahren und Monaten';
$txt['attachments_auto_days'] = '(Auto) Unterteilen von Jahren, Monate und Tage';
...
$txt['attachments_auto_space'] = '(Auto) Wenn entweder Verzeichnis Speicherplatzbegrenzung erreicht ist';

$txt['use_subdirectories_for_attachments'] = 'Erstelle ein neues Verzeichnisse innerhalb eines Basisverzeichnis';
$txt['use_subdirectories_for_attachments_note'] = 'Andernfalls werden alle neuen Verzeichnisse innerhalb des Forums Hauptverzeichnis erstellt.';
$txt['basedirectory_for_attachments'] = 'Ein BasisvVerzeichnis für Dateianhänge festlegen';
$txt['basedirectory_for_attachments_current'] = 'Aktuelles Basisverzeichnis';
$txt['basedirectory_for_attachments_warning'] = '<div class="smalltext">Bitte beachte, dass das Verzeichnis ist falsch. <br>(<a href="' . $scripturl . '?action=admin;area=manageattachments;sa=attachpaths">Versuch zu korrigieren</a>)</div>';
$txt['attach_current_dir_warning'] = '<div class="smalltext">Es scheint ein Problem mit diesem Verzeichnis sein. <br>(<a href="' . $scripturl . '?action=admin;area=manageattachments;sa=attachpaths">Versuch zu korrigieren</a>)</div>';

$txt['attachment_transfer'] = 'Dateianhänge übertragen';
$txt['attachment_transfer_desc'] = 'Dateien zwischen Verzeichnissen übertragen.';
$txt['attachment_transfer_select'] = 'Verzeichnis auswählen';
$txt['attachment_transfer_now'] = 'Übertragen';
$txt['attachment_transfer_from'] = 'Übertrage Dateien von';
$txt['attachment_transfer_auto'] = 'Automatisch durch freiem Platz oder Dateianzahl';
$txt['attachment_transfer_auto_select'] = 'Bsisverzeichnis auswählen';
$txt['attachment_transfer_to'] = 'Oder in ein bestimmtes Verzeichnis.';
$txt['attachment_transfer_empty'] = 'Leere das Quellverzeichnis';
$txt['attachment_transfer_no_base'] = 'Keine Bsisverzeichnisse zur Verfügung.';
$txt['attachment_transfer_forum_root'] = 'Forum Rootverzeichniss.';
$txt['attachment_transfer_no_room'] = 'Verzeichnisgröße oder Dateianzahl Grenze erreicht.';
$txt['attachment_transfer_no_find'] = 'Keine Dateien zum Übertragen gefunden.';
$txt['attachments_transferred'] = '%1$d Dateien übertragen zu %2$s';
$txt['attachments_not_transferred'] = '%1$d Dateien nicht übertragen.';
$txt['attachment_transfer_no_dir'] = 'Entweder das Quellverzeichnis oder die Ziel Optionen wurden nicht ausgewählt.';
$txt['attachment_transfer_same_dir'] = 'Du kannst nicht das gleiche Verzeichnis als Quelle und Ziel auswählen.';
$txt['attachment_transfer_progress'] = 'Bitte warte. Übertragung läuft...';
...
$txt['avatar_server_stored_groups'] = 'Mitgliedergruppen, die ein Avatar wählen dürfen';
$txt['avatar_upload_groups'] = 'Mitgliedergruppen, die ein Avatar hochladen dürfen';
...
$txt['not_done_reason'] = 'Um das Überlasten des Servers zu verhindern, wurde der Prozess kurzzeitig pausiert. Er sollte in ein paar Sekunden automatisch weiterlaufen. Sollte dies nicht geschehen, klicke bitte auf \'Weiter\'.';
