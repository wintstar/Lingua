...
$txt['admin_main_welcome'] = 'Das ist dein "%1$s". Hier kannst Du die Einstellungen ändern, das Forum warten, Protokolle anschauen, Pakete installieren, die Themes verwalten und viele weitere Optionen verändern. <div style="margin-top: 1ex;">Sollst Du Probleme haben, lese bitte den Abschnitt "Allgemeiner Support &amp; Fehler" im Bereich Support &amp; Credits. Sollten diese Informationen nicht helfen, kannst Du auch im <a href="http://www.simplemachines.org/community/index.php" target="_blank">Support Forum</a> nach Hilfe fragen.</div> Bitte klicke auch das <img src="' . $settings['images_url'] . '/helptopics.gif" alt="%2$s" title="%3$s" class="new_win" /> Symbol an, um eine Beschreibung der Funktion zu erhalten.';
...
$txt['attachments_desc'] = 'Hier kannst Du Einstellungen zu den Dateianhängen und Benutzerbildern machen, diese nach Datum und Größe löschen, Statistiken anschauen und die Wartung durchführen.';
...
$txt['package_info'] = 'Hier kannst Du neue Funktionen für das Forum installieren.';
$txt['theme_admin'] = 'Theme &amp; Layout';
$txt['theme_admin_info'] = 'Hier kannst Du Themes verwalten und die Einstellungen für das Layout anpassen.';
...
$txt['maintain_info'] = 'Hier kannst Du Datensicherungen machen, die Datenbank optimieren bzw. auf Fehler prüfen und Boards von ihren Daten leeren.';
...
$txt['pruning_log_desc'] = 'Verwende diese Werkzeuge um ältere Einträge in verschiedenen Logs zu entfernen.';
...
$txt['support_credits_info'] = 'Hier erhälst Du Hilfe bei häufigen Problemen sowie Informationen über die aktuelle Version.';
...
$txt['edit_permissions_info'] = 'Ändere die Berechtigungen global oder boardspezifisch.';
...
$txt['attachmentUploadDir_multiple_configure'] = '<a href="' . $scripturl . '?action=admin;area=manageattachments;sa=attachpaths">[Konfiguriere mehrere Verzeichnisse]</a>';
...
$txt['avatar_server_stored'] = 'Auf einem Server gespeicherte Benutzerbilder';
...
$txt['custom_avatar_dir_desc'] = 'Es sollte nicht das gleiche Verzeichnis wie für die auf einem Server gespeicherten Benutzerbilder sein.';
