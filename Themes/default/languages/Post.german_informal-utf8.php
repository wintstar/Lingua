...
$txt['enter_verification_details'] = 'Gib die Verifikationsdetails ein';
...
$txt['post_too_long'] = 'Dein Beitrag ist zu lang. Bitte gehe zurück, kürze ihn und sende ihn erneut ab.';
...
$txt['rich_edit_wont_work'] = 'Dein Browser unterstützt das Editieren mit Rich Text nicht.';
...
$txt['attachment_requires_approval'] = 'Bitte beachte, dass keine Datei ohne Genehmigung eines Moderator angehängt wird.';
$txt['error_temp_attachments'] = 'Es wurden Dateianhänge gefunden, die Du angefügt aber nicht abgesendet hast. Diese Anhänge werden nun an diesen Beitrag angehängt. Wenn Du nicht möchtest, dass sie diesem Beitrag angefügt werden, kannst Du die Anhänge <a href="#postAttachment">hier< a> entfernen.';
// Use numeric entities in the below string.
...
$txt['board_moderate'] = 'in einem Board welches Du moderierst';
...
$txt['post_visual_verification_desc'] = 'Bitte gib den Code aus dem Bild ein, um den Beitrag zu erstellen.';
...
$txt['more_attachments_error'] = 'Du kannst nicht mehr Dateianhänge hinzufügen.';
...
$txt['error_new_reply'] = 'Achtung - während Du geantwortet hast, ist eine neuer Beitrag geschrieben worden. Du solltest das Thema erneut lesen.';
$txt['error_new_replies'] = 'Achtung - während Du geantwortet hast, sind %1$d neue Beiträge geschrieben worden. Du solltest das Thema erneut lesen.';
$txt['error_new_reply_reading'] = 'Achtung - während Du das Thema gelesen hast, wurde ein neuer Beitrag geschrieben. Du solltest das Thema erneut lesen.';
$txt['error_new_replies_reading'] = 'Achtung - während Du das Thema gelesen hast, wurden %1$d neue Beiträge geschrieben. Du solltest das Thema erneut lesen.';

$txt['announce_this_topic'] = 'Sende eine Ankündigung über dieses Thema an die Mitglieder:';
$txt['announce_title'] = 'Ankündigung senden';
$txt['announce_desc'] = 'Dieses Formular erlaubt Dir das Senden einer Ankündigung an die ausgewählten Mitgliedergruppen über dieses Thema.';
...
$txt['digest_intro_daily'] = 'Hier ist eine Zusammenfassung aller heutigen Aktivitäten in Deinen abonnierten Boards und Themen im %1$s. Zum Abbestellen folge bitte den unten stehenden Link.';
$txt['digest_intro_weekly'] = 'Hier ist eine Zusammenfassung aller Aktivitäten dieser Woche in Deinen abonnierten Boards und Themen im %1$s. Zum Abbestellen folge bitte den unten stehenden Link.';
